...
const TableBroadcasters = () => {
  return (
    <div class="flex max-w-3xl px-4 mx-auto sm:px-8 border mt-10">
      <div class="py-8">
        <div class="flex flex-row justify-between w-full mb-1 sm:mb-0">
          <h2 class="text-2xl leading-tight">Broadcasters Table</h2>
          <div class="text-end">
...
export default TableBroadcasters;
